...
/*
На основании примера c ArrayList (Solution11_4_1) разовьем наш пример, c помощью интерфейса Set (применив методы equels и hashCode())
В автосалон привезли несколько десятков авто. Нужно составить каталогг, чтобы в нем не повторялись марка и модель авто.
 */
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Car car10 = new Car(TOYOTA, "Corolla", false);  //1. Добавляем машин в магазин
        ...
        carList.add(car8);
        carList.add(car9);
        carList.add(car10);     //2. созданные машины добавляем в коллекцию
        carList.add(car11);
        carList.add(car12);
        carList.add(car13);
        carList.add(car14);
    ...
    Set<Car> carSet = new HashSet<>(carList);   //3. Создаем интерфейс Set, в который помещаем carList

    for(Car car : carSet) {         //4. с помощью цикла for:each выводим в консоль авто

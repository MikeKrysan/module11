...
/*
тут показано что есть класс Sorted в котором есть 2 поля (полей может быть сколько угодно), и по одному полю у нас происходит сортировка,
но конструктор принимает все эти 2 поля вот и все, а так да операций со строками тут никаких нет
 */